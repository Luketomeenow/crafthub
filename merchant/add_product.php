...
session_start();
    ...
    if (isset($_POST['add_product'])) {
        ...
        $merchant_id = $_SESSION['merchant_id']; // Assuming you have stored the merchant ID in a session variable
        ...
        $insert_product_query = "INSERT INTO merchant_products (merchant_id, product_name, product_desc, stock, category, material, product_img) VALUES ('$merchant_id', '$product_name', '$product_desc', '$stock','$categ' ,'$material','$product_image')";
        ...
        if ($result) {
            ...
            for ($i = 0; $i < count($sizes); $i++) {
                ...
                $insert_size_query = "INSERT INTO product_sizes (product_id, merchant_id, sizes, price) VALUES ('$product_id', '$merchant_id', '$current_size', '$price')";
            ...
            foreach ($colors as $color) {
                ...
                $insert_color_query = "INSERT INTO product_color (product_id, merchant_id, color) VALUES ('$product_id', '$merchant_id', '$color')";
