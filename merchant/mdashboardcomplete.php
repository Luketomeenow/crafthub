<?php 
    ...
    $select = "SELECT 
            ...
            WHERE 
                mp.merchant_id = '$merchant_id' AND o.status = 'order received'";
...
<div class="container">
    <div class="row">
    <h1 class="card-title"><i class="fa-solid fa-table-list" id="complete"></i> Completed Orders</h1>
    </div>
            <div class="row">
                        <form action="#">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="d-flex align-items-center">
                            <div class="order-details"><?php echo $row['fname'] . ' ' . $row['mname'] . ' ' . $row['lname']; ?>
