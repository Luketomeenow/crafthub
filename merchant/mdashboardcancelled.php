<?php 
    ...
    $select = "SELECT 
            ...
            WHERE 
                mp.merchant_id = '$merchant_id' AND o.status = 'cancelled'";
...
<div class="container">
    <div class="row">
    <h1 class="card-title"><i class="fa-regular fa-rectangle-xmark" id="cancel"></i> Cancelled Orders</h1>
    </div>
            <div class="row">
                        <form action="#">
            ...
            <div class="prod-container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="order-id-container" style="display:none;">
                ...
                <div class="col-md-1">
                    ...
                    <div class="product-detail" id="cancelled">
                        <h5>cancelled</h5>
                    </div>
                </div>
                <hr class="solid4">
