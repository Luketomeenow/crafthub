<?php 
    ...
    $select = "SELECT 
            ...
            WHERE 
                mp.merchant_id = '$merchant_id' AND o.status = 'preparing'";
...
<div class="container">
    <div class="row">
    <h1 class="card-title"><i class="fa-solid fa-truck" id="ship"></i> To Ship Orders</h1>
    </div>
            <div class="row">
                        <form action="#">
            ...
            <div class="prod-container">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="d-flex align-items-center">
                            <div class="order-details"><?php echo $row['fname'] . ' ' . $row['mname'] . ' ' . $row['lname']; ?></div>
                            <div class="order-details"><?php echo $row['user_adds']; ?></div>
                            <div class="order-details"><?php echo $row['contact_no']; ?></div>
                        </div>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="col-md-1">
                    ...
                    <div class="product-detail">
                        <button type="button" class="btn btn-success delete-btn"><a href="ship_order.php?order_id=<?php echo $row['order_id'] ?>">Ship Order</a></button>
                    </div>
                </div>
                <hr class="solid4">
                </div>
